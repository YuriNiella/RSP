...
You can use the function `suggestSize()` in your base raster (shapefile) file to get suggested dimensions for a projected plot, and easily change the colour of the land mass using `land.col`. Lastly, you can use the function `addStations()` can be used to **add the station locations** to your plot.:
