...
(2) Calculating utilization distribution areas using dynamic Brownian Bridge Movement Models (dBBMM)
...
![Same track animated both using **only the receiver locations** and **receiver and RSP positions combined**.](vignettes/animationRSP.gif){#id .class width=680}
