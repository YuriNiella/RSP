...
In the example above (daily timeslots set using `timeframe = 24`) we can notice that in the four first `timeslot` none of the three groups monitored were detected, whereas both **Bream** and **Tarwhine** groups got detected in **slot 404** and
from **slot 405** to **slot 410** only **Tarwhine** were detected. 
